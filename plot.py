...
def att():
    ...
    model.load_state_dict(torch.load('./new_checkpoint/ft_5.bin')['model'])
    model = model.cuda()
    model.eval()
...
def viz(bones):
    ...
    img_list = [
            ...
            # "h36.jpg"
            # "dataset/S1/Seq1/imageSequence/full_video_2/frame000002.jpg",
            # "../human36m/human36M/protocol_1/S5/Directions_2/imageSequence/58860488/img_000501.jpg"
            ]
    k = 1
    fig = plt.figure()
